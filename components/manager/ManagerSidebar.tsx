...
import { LayoutDashboard, Users, Share2, LogOut, CheckSquare } from "lucide-react"
...
const navItems = [
  ...
  { href: "/manager/shared-goals", label: "Push Shared Goal", icon: Share2 },
  { href: "/manager/checkins", label: "Check-ins", icon: CheckSquare },
]

export function ManagerSidebar({ user }: { user: any }) {
      ...
      <div className="px-4 py-4 space-y-3">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <Badge variant="outline" className="text-xs mt-0.5">Manager</Badge>
          </div>
        </div>
        <Button
          variant="ghost"
